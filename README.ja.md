...
> **ホスト版**: <https://sakilabo.jp/survey-id-generator/> でそのまま使えます。自前でホストする場合は [セットアップ](#セットアップ) を参照してください。

## 想定するシーン

PTA・町内会・同窓会・社内アンケートなど、配布対象に **事前に個別の「アンケート ID」を渡して** アンケートを実施したい場面で使います。規模は数十人から数万人まで幅があります。
